...
const Producto = ({ nombre, img, id, categoria }) => {
	return (
		<div className="shadow-xl w-56 md:w-60 lg:w-80 h-96 border-2 border-gray-800 rounded-lg bg-white flex flex-col hover:shadow-3xl">
			<img
				src={img}
				alt={nombre}
			...
			<div className="p-5 flex flex-col">
				<h3 className="text-xl font-semibold text-center h-12 overflow-hidden whitespace-nowrap	text-ellipsis ">{nombre}</h3>
